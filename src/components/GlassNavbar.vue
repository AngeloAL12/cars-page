  ...
  >
    <div
      ...
      :class="[
        ...
        'px-4 py-3',
        'md:w-fit md:px-2 md:py-2 md:rounded-2xl md:justify-center',
      ]"
    >
      <div
      ...
      <div ref="navContainer" class="hidden md:flex items-center gap-1 relative">
        ...
        <RouterLink
          to="/"
          data-path="/"
          class="relative z-10 px-4 py-2 text-sm font-medium text-white/90 hover:text-white rounded-xl transition-colors duration-200 flex items-center gap-2"
        >
